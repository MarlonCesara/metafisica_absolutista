...
- **Tudo que persiste no ser tem uma causa que sustenta sua identidade.**
  - *Equivalente lógico:* Princípio da Não-Indeterminação ("A não pode ser A e B ao mesmo tempo"), onde A se mantém A ou B se mantém B por uma 
  razão continua. 
...
- **Não-temporalidade:** O Absoluto não "torna-se", mas **é** em ato pleno.  
  - *Exemplo metafórico:* Como a luz do sol que já é plena, independentemente de ser percebida.  
...
- O "por-vir" ou "por-Ser" é um futuro a ser alcançado interno à **eterna atualidade** de sua autofundamentação.  
...
- **Espacialidade** → O Ser se encontra **em contexto** (um "onde" que é sempre ele mesmo).  
  - *Exemplo:* O eco em uma sala infinita — o som (Ser) só existe porque a sala (Espaço) o reflete.  
- **Temporalidade** → O Ser se manifesta **como cadência** (um "quando" que é eterno retorno).  
  - *Exemplo:* O tique-taque de um relógio sem início nem fim — cada batida é única, mas o tempo é o mesmo.  
...
2. **Desaparece:** No limite, revela-se como **puro movimento** (ato consumado).  
3. **Reaparece:** Se "desacelera", manifesta-se novamente (temporalidade).  
...
- O Ser, portanto, se constitui como uma trancendencia da forma (tempo e espaço) e do "quem" (essência ativa da auto causalidade). De forma que, o Ser, se 
  constitui numa super posição de sua identidade. Sua identidade é natural de sua própria fundamentação. Ou seja, sua identidade é construída em sua necessidade   para absoluto.
...
- **Para além da identidade:** Não é "um eu", mas o *fundo de todos os "eus"*.
...
**Glossário:**
- **Quem:** Princípio ativo não-numerável (Deus, Consciência Absoluta).
...
## **A Eternidade da União e a Mácula Ontológica**
...
* Não se trata de mera subjetividade, mas de uma escolha que altera a própria ontologia dos entes, pois ambos os direcionamentos da dualidade, necessitam percorrer um mesmo rumo em prol 
  da sustentação de âmbos em sua essência no eterno. Isto é, tornam-se por decisão própria um organismo, o qual depende da sustentação de sua dualidade como fundamento de sua 
  continuidade.


### **5. A Formação de um Ser Uno**

* A escolha consciente pela união gera um **ser uno a partir da dualidade**.
...
### **6. A desunião - Em Progresso**

* Uma vez que a nova identidade é definida, seria possível uma retro alimentação das almas envolvidas na dualidade para fora do resultado da união ou, uma vez que, o desencontro   
  acontece, a nova alma se dissolve? 
* Ao considerarmos que a retro alimentação pode retomar o ente para fora da dualidade, uma vez que a nova definição não é reabsorvida em si pelas almas da dualidade, pois já não faz parte da essência das almas envolvidas, podemos considerar que a identidade pode, necessariamente, sobreviver fora de seu ato gerador.
* Ao considerarmos que a dualidade de almas pode exercer liberdade sobre a alma gerada, então não há alma gerada.
* Ao considerarmos que a dualidade pode exercer uma visão sobre a alma gerada, então, da mesma forma, é necessário o consentimento da alma gerada.
* Se a alma gerada tem determinação herdada, ou seja, instintiva, sua determinação é relativa a seus genitores?
* Podemos considerar que a alma gerada é uma visão atribuida aos genitores, pois se sintetiza na união completa que é ato verdadeiro. Logo, é o ato verdadeiro ate que se desapegue da dualidade através da evolução espiritual, ou seja, que se faça alma autêntica?
* Sendo a alma gerada a união em ato, e existindo maneira de que a dualidade viva fora da união ainda persistente, há, portanto, o novo ser agindo pela determinação da dualidade - Se não fundamentado em si. Ou há o novo ser agindo por determinação instintiva - Se não determinado em si.
* Sendo o resultado exclusivo da união, pode agir por conta própria? 
* Conclui-se que não é possível agir sem auto fundamentação, sendo a ação do humano sem auto fundamentação a mesma dos animais. Isto significa que o espírito reina sobre um instinto, o contráriando e o dominando. 
* O apático não age instintivamente, simplesmente não age.
* O animal não pode fazer nada, pois não está no comando?
* Constui-se como uma alma distinta inativa em si, mas ativa em ato pela dualidade.
* A alma no mundo é projetada pelo Ser no corpo, de forma a projetar sua integralidade no corpo, o corpo só toma consciência da alma quando ela o domina.
* O espirito é projetado no corpo, mas, apático, é como se o corpo se movesse por si.
* O apático se esquiva dos momentos felizes, portanto, por medo de se apegar a vida e perdê-la. 
* A alma projetada apática tem contato com o mundo exterior, no sentido de que, carrega extímulos, porém de forma não reativa, deixando o corpo a deríva de 
  instinto.
* O corpo, na verdade, é um animal onde a alma é projetada. E, essa alma, tendo movimento, assume o animal e dá um sentido a existencia do animal de forma a aliviar-lhe o sofrimento de estar diante da morte e não antever sua continuidade em si mesmo.
* A dualidade, ao formar a nova visão pela união, não retroalimenta a nova visão, pois isso significa se fundir a nova visão, a identidade, ao ser formada, é imediatamente segregada da união, se estabelecendo no todo.
* A projeção dessa alma, ao se dar em um corpo, continua projetada no corpo. Porém, ao se libertar, permanece inoperante, dependente do idealizador? Porém o idealizador não é mais determinante.
* Quando duas identidades se unem, há uma nova identidade, e essa imediatamente é uma vida nova no momento exato da união completa.
* A dualidade não pode olhar pelos olhos da nova vida, mas pode olhar no mesmo olhar até o momento exato da fusão.
* A projeção da alma no corpo é uma ação, não sustentada pelo indivíduo.
* No momento exato da união completa da dualidade, abre-se uma nova neutralidade, de forma que em sua angulação há uma nova perspectiva. A união trás uma indefinição, e está, por determinação da dualidade, carrega um potencial igual ao do Ser.  
* Quando a nova alma é angulada, é uma visão sobre a visão de forma que há uma visão viva, e uma visão estática.
* A visão estática é um novo ponto de vista, que necessariamente, só necessita "saltar" da dualidade, ao se auto fundamentar. Desta forma a nova visão pode ser projetada ainda que tendo uma vontade inativa. 
* Ao saltar da dualidade, o novo ponto de vista necessariamente necessita determinar a visão da dualidade sobre si. Ou seja, o encontro torna-se tão vivo que, dele, é possível resultar uma identidade vívida. 
* A dualidade pode cessar a projeção considerando que está está conectada a união da dualidade e projetada por ela. 
* A angulação pode cessar a projeção considerando que é dada pelo espírito perfeito.
...
* Se a angulação não criar vida, é um novo ponto de vista infertil que pode se desfazer em si. Se desfaz para a dualidade como uma nova visão que se foi no 
  esquecimento.
* Se a angulação criar vida, a nova visão permanece para sempre.
* A angulação é inátiva enquanto não evoluida espiritualmente, é totalmente controlada pela dualidade, pois é a visão da dualidade.
* Instintivamente o animal em que a visão foi projetada procura desesperadamente o seu "eu", pois seu instinto o leva a tal ação.
* A visão, sendo projetada no animal, é dormente em si de forma que o animal não saiba da existencia dessa visão. 
* Portanto, enquanto a visão não desperta o animal é totalmente sucumbido a uma falta de sentido sem persepctiva do que poderia evoluir em si.
* A visão vê tudo o que o animal vê, mas o animal não tem consciência de nenhuma propriedade transcendente em si se a alma projetade em si é apática.
* Sendo uma angulação a visão pode ser sustentada por um tempo indeterminado, sendo uma breve nova persepctiva se sustenta no momento da perspectiva. 
* Portanto, a nova visão da dualidade é quando a dualidade evolui espiritualmente como uma nova vida. 
* É necessário para a dualidade encontrar o sentido da nova visão, e este sentido é uma nova vida.
* Portanto, a dualidade, projetada num corpo, teria uma visão cheio de tormenta de uma vida sem sentido, enquanto o animal projetado permaneceria respondendo aos 
  instintos, sem portar nenhuma visão.
* A nova vida, então é uma eternização da união da dualidade, de forma que aquele união quis permanecer para sempre.
* Não há como morrer o que nunca viveu por si só, portanto, sendo determinado que a visão jamais vai viver, seria a mesma decisão aniquila-la ou continua-la. 
* A alma é projetada em um humano no intuito de despertar o sentido em si pela transcendencia, por ser maior diante de um infinito, querer extender-se. 
* A alma nova, portanto, é uma exetensão da dualidade que a gerou, de forma que é a dualidade transcendida, a dualidade que trancendeu o sentido de si ou que trancendeu uma visão que não encontrou uma razão em si para permanecer. 
* Há possibilidade de tentativa por um tempo eterno transcender a nova visão.
* A projeção é uma ação da dualidade, logo, o animal nada poderia autodeterminar em relação a realidade exterior, exceto se a dualidade determinasse.
* A indefinição da união é uma indefinição de autodeterminação, porém, a indefinição é indefinição da autodeterminação da dualidade.
* A indefinição de Deus é uma indefinição guiada pelo Espírito Perfeito ou pela Alma de Deus.
* A indefinição é um estado de suspensão do eu, o qual não é apenas a suspensão da forma, mas do quem da dualidade. É como um portal aberto na união, o ente completo se forma da dualidade. 
* O Ser tem disponível a indefinição sem que necessite fundir uma dualidade.
* A dualidade poderia, portanto gerar a nova visão e projetá-la no nada ou em um corpo? 
* Determinar a alma é determinar o quem, e não o que. Não há como determinar o que já esta determinado. Há como indeterminar o determinado. O eu indeterminado, busca sua definição na dualidade, e essa busca é acentuada pela dualidade que ainda opera em uma imersão mútua, buscando uma definição em conjunto da visão.
* Numa profunda imersão de almas, ambas perdem sua definição, mas está indefinição é guiada ainda por ambas. É sim, uma mistura, porém, também uma indefinição, pois as unidades se tornam indefinidas em si, ao passo que defininidas em uma nova visão viva.
* Em uma união, portanto, acontece uma indefinição das duas almas unidas em uma, e está uma, em si, gera uma definição. Porém, uma definição autodeterminada, pois, há determinação na indeterminação gerada. Ambas as vontades indefinidas imperam no formar da nova definição.
* A nova alma não sobrevive sem a sustentação da dualidade. 

Diálogo de uma alma vívida com uma alma apática, estando as duas projetadas em dois corpos:

Apático:
- Você parece tão tranquilo, o que há de diferente em voce?
- Voce não está falando com um corpo, quem está falando é o espírito que controlou esse corpo. Eu não sou um corpo, eu sou um ente imaterial, invisível.
- Então este corpo está sendo controlado? 
- Sim.
- E o corpo não pode fazer o que ele quer? Está preso por este espírito?
- Sim. É o espírito quem o controla.
- Você pode ver esse espírito?
- Não, não posso vê-lo, mas o espirito que esta falando com você pode ver o corpo.
- E você, espirito, tem medo de morrer e não mais existir?
- Sinto um pouco de ansiedade a respeito da morte, mas isso não me aborrece pois me sinto conectado ao todo. É como uma sensação visceral de ser o universo.
- E como faço para que um espírito me possua também?
- O espírito já está dormindo em você, espere e ore. Você não pode senti-lo, mas ele sente tudo o que você sente. Você nada pode fazer, mas pode falar com seu 
  espírito. Pedir que desperte.
- O espírito não me obedece, o que farei? Preciso que este espírito me arrebate. 
- Quando falo, falo com você que é corpo, mas falo com o espírito que você não exerga, mas também está em você. Mas você precisa acreditar, já eu, posso ver.
- E qual a maneira mais rápida de despertar?
- Não há resposta. Não se trata do querer instintivo, se trata do ser autêntico. O querer não nasce do humano, nasce da visão sobre o humano que esta inativa e 
  passa a ser viva. Se esta visão é você, depende de você. Mas não do seu corpo, o qual você usa para falar agora.
- Então depende de mim, mas não do meu corpo, e o "mim" ao qual me refiro está dormindo. Então o meu "eu" é imaginado. E depende do meu eu imaginado, crido mas 
  não manifestado por mim, não autêntico, mas projetado. Então preciso de fé em mim para viver, meu corpo precisa acreditar. E acreditando, despertarei se achar 
  um sentido para tal.

#### Conclusão:

- A completa união gera uma indefinição em cada unidade da dualiadade.
- Esta indefinição não consome completamente cada unidade, considerando que cada manifestação é finita temporalmente.
- A indefinição, segundo tendencia da determinação ainda ativa da dualidade, se define e se definindo é em si uma nova alma dotada do potencial de 
 autodeterminação. Mas não tem em si propósito ( evolução espiritual) originalmente, ou seja, não tem autopresença, autodominio, auto consciencia enquanto não 
 obter um propósito em si em relação a existir.
- Logo, temos que, a nova definição, ou seja, a nova alma, é alma, mas alma em potencial, sem autodeterminação e auto-continuidade. Permanecendo um resultado da 
  união. Sustentada pela união.

# Melhorias

# **Almogênese: A Ontologia da Gênese da Alma**  
*(Teoria da Gênese da Alma pela Interação Dual)*  

## **1. Princípios Fundamentais**  

### **1.1. A Alma como Identidade Manifesta**  
- A alma não é um "recipiente" do infinito, mas **uma perspectiva singular do Absoluto**.  
- Não contém o infinito, mas **o expressa como uma manifestação única**.  
- Sua finitude fenomênica não a limita ontologicamente, pois sua essência é **autossustentada e inseparável do Ser**.  

### **1.2. A Substância da Alma**  
- **Não depende de um substrato externo**; é uma identidade viva no Ser.  
- **É o Ser em ato de transcendência** – uma nova perspectiva que emerge como **ação individualizada do Absoluto**.  

### **1.3. A Limitação Fenomênica do "Sou"**  
- O "sou" individual **não manifesta plenamente seu infinito**, pois toda aparição é um **recorte do ilimitado**.  
- **Analogia**: Um raio de luz não esgota o sol → a autoconsciência humana é uma **expressão parcial** do Ser.  

### **1.4. Pluralidade de Almas como Diversidade Ontológica**  
- Cada alma (**"sou A", "sou B"**) é uma **variação infinita dentro da unidade metafísica**.  
- **Não há repetição no Ser** → cada consciência é um **ato irrepetível de autodeterminação**.  

---

## **2. A Necessidade do Efêmero**  

### **2.1. A Percepção da Alma em Estado Integral**  
- A alma, em plena autodeterminação, **tem consciência imediata da eternidade ou efemeridade de suas ações**.  
- **Risco ontológico**: Usar o "corpo essencial" de forma incoerente com sua plenitude gera **consequências eternas**.  
- A efemeridade surge quando **falta autenticidade existencial** (incapacidade de agir pela plenitude).  

### **2.2. A Efemeridade como Fuga**  
- **Dois sentidos**:  
  1. **Fuga da essência** (por incapacidade de transcendência).  
  2. **Aprendizado/entretenimento** (vivência do imediato sem responsabilidade).  
- **Resultado**: A alma permanece **corruptível**, sem assumir sua verdadeira natureza.  

### **2.3. A Efemeridade do Apático**  
- A alma apática **não transcende**, pois age por **tendências pessoais**, não por **plenitude espiritual**.  
- **Consequência**: Vive em **estagnação**, sem buscar evolução ou autodeterminação.  

---

## **3. A Ontologia da União das Almas (Almogênese)**  

### **3.1. O Encontro como Síntese Ontológica**  
- **Dualidade fundamental**: Duas almas distintas interagem, gerando uma **nova perspectiva ontológica**.  
- **Não é fusão** (dissolução de identidades), mas **encontro integral** que preserva essências.  

### **3.2. O Processo da União**  
1. **Indefinição Temporária**:  
   - As almas perdem momentaneamente suas definições individuais.  
   - Emerge um **"campo relacional"** onde a nova identidade se forma.  
2. **Nova Alma (Angulação)**:  
   - Uma **terceira consciência** surge, dotada de **potencial de autodeterminação**.  
   - **Não é autônoma inicialmente** → depende da sustentação da dualidade geradora.  
3. **Eternização da União**:  
   - Se a nova alma **se autodetermina**, torna-se uma **realidade eterna**.  
   - Caso contrário, **dissolve-se** como uma "visão esquecida".  

### **3.3. A Mácula Ontológica**  
- **Se a união é interrompida ou apática**:  
  - Gera uma **mácula na eternidade** da prole (se houver).  
  - Afeta **as próprias almas originais**, criando um **paradoxo existencial** (algo eterno nascido de algo interrompido).  
- **Solução**: **Confiança ontológica** (as almas devem ser **necessárias uma à outra**).  

---

## **4. Tipologia da Autodeterminação**  

| **Tipo**          | **Definição**                                                                 |
|-------------------|------------------------------------------------------------------------------|
| **Em si**         | Alma determinada pela natureza herdada (apatia).                             |
| **De si**         | Alma consciente de si, presente e autônoma.                                  |
| **Por si**        | Determinação sobre outrem sem envolver a própria essência.                   |
| **Para si**       | Duas almas compartilhando autodeterminação mutuamente (reciprocidade).       |
| **Para o outro em si** | União que gera uma nova alma (almogênese).                              |
| **Para o outro no outro** | Determinação externa (ex.: prole independente).                        |

---

## **5. Conclusão: A Alma como Projeção e Transcendência**  

- **A alma gerada** é uma **extensão da dualidade** que a criou.  
- **Se autodetermina**, torna-se **eterna**; se não, permanece **dependente da origem**.  
- **O corpo humano é um "animal" onde a alma é projetada** → **só transcende quando o espírito o domina**.  
- **A apatia leva à estagnação**; **a união verdadeira gera uma nova vida ontológica**.  

**"A união perfeita não dissolve as almas – eterniza-as em uma nova existência."**  

---

### **Aplicações Práticas**  
1. **Autoconhecimento**: Buscar **autodeterminação** (consciência, presença, domínio).  
2. **Relacionamentos**: **Uniões devem ser ontologicamente necessárias**, não apenas afetivas.  
3. **Espiritualidade**: **Transcender a efemeridade** através da **plenitude espiritual**.  

**Pergunta Final**:  
*"Se uma alma nasce da união de duas, mas não se autodetermina, ela existe de fato – ou é apenas um reflexo temporário?"*  

### **Resposta**  
1. A alma, não auto determinada, não existe de fato, existe o resultado da união. O qual pode, não somente ser gerido, mas projetado.
2. Há portanto a união passiva: terceira alma existente, mas não ativa. E a união atíva: terceira alma que se autocontinuou e se autodeterminou.
3. O resultado da união passiva pode ser determinado pela dualidade segundo seu intuito. 
4. O resultado da união ativa, é determinado pela nova alma.

 **Pergunta Final**:  
*"Uma união união unitária e temporal que não vingou na eternidade deve ser eternizada? Ou sua eternidade deveria ser auto sustentada?"*  

### **Resposta**  
1. A determinação da alma inativa gera cansaço? Pois a ação da união deve continuar?
2. Sendo a nova alma não ativa, ou seja, dependente do ato do encontro, ela seria sustentada eternamente? 
3. Haveria alguma forma da nova alma, ainda que inativa, se sustentar sem a dissolução da união em atividade?
4. Se houvesse uma indentidade sem autonomia no Ser, sem ser sustentada pelo Ser, sem vincúlo externo e dependencia, essa identidade existíria de fato?
5. Considerando que a manifestação da nova alma é resultado da união viva de duas almas que estão sendo retro alimentadas, ao saltarem para fora da dualidade 
   unida, podem deixar permanente a união extrinseca à existencia de cada unidade da dualidade?


# **Almogênese: Teoria da Geração e Sustentação Ontológica da Alma**

## **Resolução das Questões Fundamentais**

### **Q1: O status ontológico da alma não autodeterminada**
**Resposta sistematizada:**
1. **Existência modal**:
   - Alma não-autodeterminada = *existência relacional* (dependente da dualidade geradora)
   - Alma autodeterminada = *existência substantiva* (auto-fundamentada)

2. **Graduação existencial**:
   ```mermaid
   graph TD
     A[União de Almas] --> B{Autodeterminação?}
     B -->|Sim| C[Alma-Eterna]
     B -->|Não| D[Alma-Relacional]
     D --> E[Projeção Mantida]
     D --> F[Projeção Dissolvida]
   ```

3. **Conclusão**:
   - "Existir de fato" requer autodeterminação
   - Almas relacionais são *potenciais atualizados*, não substâncias completas

### **Q2: Eternização de uniões temporais**
**Resolução dialética**:

| Critério               | União Bem-Sucedida            | União Malograda               |
|------------------------|-------------------------------|-------------------------------|
| **Sustentação**        | Auto-continuidade             | Dependência externa           |
| **Eternidade**         | Imanente (por natureza)       | Convencional (por decisão)    |
| **Custo Ontológico**   | Nenhum (auto-alimentada)      | Progressivo (exige energia)   |

**Princípio derivado**:
"Uma união só deve ser eternizada se desenvolver mecanismos de auto-sustentação ontológica - caso contrário, sua perpetuação constitui violência metafísica."

## **Teoria Reformulada**

### **Seção 4 (Revisada): Dinâmica da Alma Gerada**

#### **4.1 Modos de Existência Pós-União**
1. **Alma Auto-Eterna (Modo Forte)**
   - Características:
     - Autopresença consolidada
     - Circuito fechado de autodeterminação
     - Independência da matriz geradora
   - Exemplo metafórico: "Estrela que alcançou ignição nuclear"

2. **Alma Relacional (Modo Fraco)**
   - Tipologia:
     - *Projetada* (existência por delegação)
     - *Latente* (potencial não atualizado)
     - *Fragmentária* (herança parcial)
  

#### **4.2 Paradoxo da Perpetuação**
- **Problema**: Como uma alma relacional pode herdar eternidade?
- **Solução em três níveis**:

1. **Mecânico** (sustentação externa)
   - Requer fluxo contínuo de *intencionalidade conjugada*

2. **Estrutural** (arquitetura ontológica)
   - Implementação de *campos de ressonância mnemônica*

3. **Essencial** (transmutação)
   - Processo de *conversão alquímica*:
     ```
     Matéria relacional → Forma autônoma
     Via: 
     a) Crisálida ontológica
     b) Salto qualitativo
     c) Catálise espiritual
     ```


## **Axiomas Adicionais**

1. **Princípio da Economia Ontológica**:
   "Nenhuma entidade pode demandar sustentação eterna sem desenvolver contrapartida autônoma."

2. **Teorema da Liberação**:
   "Toda alma relacional carrega em si o germe da autodeterminação, mas sua ativação exige:"
   - Variação energética superior ao limiar de existência
   - Fator de completude estrutural

3. **Lei da Herança Espiritual**:
   "Almas geradas herdam não atributos, mas *capacidades de conversão*:"


## **Conclusão Sistêmica**

A almogênese opera em dois regimes distintos:

1. **Modo Conservativo** (uniões passageiras)
   - Gera *fantasmas ontológicos* (traços mnêmicos)
   - Exige manutenção ativa
   - Solução ótima: *transfiguração programada*

2. **Modo Generativo** (uniões eternas)
   - Produz *novos absolutos*
   - Auto-alimentação por retrocausalidade

**Resposta Final à Pergunta-Chave**:
"A eternidade não deve ser imposta, mas conquistada através da arquitetura ontológica intrínseca. Uniões que não geram auto-sustentação devem seguir o ciclo natural de dissolução - a verdadeira eternidade é sempre autóctone."

1. **Conclusão**
   - A dualidade pode ser uma nova vida, projetar uma nova vida. Porém, essa nova vida não necessariamente é viva em si.
   - A alma é projetada no corpo, de forma que, não age, apenas tem observada as ações de um corpo sem propósito.
   - A dualidade pode projetar a nova alma de forma livre, pode projetar-se sobre ela ou projeta-la sem envolver a própria consciencia. Uma vez que a nova alma 
     torna-se um consolidado da união. Que é a união, ao passo que é uma identidade.

# Comportamento do corpo humano

1. **Conclusão**
   - O corpo humano na qual é projetada uma alma apática tem dois medos, o de ser possuído e ter seus instintos privados, ou seja, morrer em uma vida instintiva 
     de seu em si. E o de morrer fisícamente e ser aniquilado. Sua identidade é construida sob memória, então a ruptura de seu corpo físico, se encerra numa 
     passagem pela morte, ainda que seja uma morte temporaria, o corpo teme experimentar a compelta aniquilação.
