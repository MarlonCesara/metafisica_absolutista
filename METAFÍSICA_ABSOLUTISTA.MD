...
Mas em que tempo age o Espírito personalizador, se este sempre existiu? A única explicação é que, diferentemente do Espírito perfeito, cuja existência e ação se dá em razão da plenitude, a alma — que exige acidentes em sua personalidade — só poderia ter sua origem na temporalidade. O espírito personalizador, portanto, teve sua primeira ação no tempo. 
000
...
> Fisicamente falando, seria possível criar hipóteses de causas para o Big Bang, se este fosse definido como o start da existência. Porém, o que haveria anterior ao Big Bang seria o relativo: uma gama infinita de possibilidades fenomênicas que não poderia derivar uma única hipótese precisa.
