...
### 1. Realidade
- **Definição:** Subconjunto do Relativo que compreende todas as possibilidades lógicas e verdadeiras. 
- **Sinônimos:**  Possibilidade. Existência lógica e possível.

### 2. Irrealidade
- **Definição:** Subconjunto do Relativo que compreende todas as impossibilidades ilógicas e verdadeiras. 
- **Sinônimos:**  Impossibilidade. Existência ilógica e impossível.

### 3. Relativo
**Definição:** Conjunto de todas as possibilidades existentes e absolutas (lógicas e possíveis,  ilógicas e impossíveis) em estado de indiferenciação.
...
- Ex: Há somente a opção de ascender a luz e ela está acesa, então alguem ascendeu. Se há a opção da luz estar acesa e apagada, e esta apagada, alguem apagou. 
  Porém, se não está acesa e nem apagada. Temos a certeza que não a agente e não há ato. Tudo existe e apenas é. Sem afirmação ou confirmação e sem um 
...
- É impossível ausentar a ausencia. É possível somente dissolve-la num cenário suspensório de possibilidades.
- Sendo o possível o unico cenário, a dissolução, ou seja, indiferenciação é impossível.
