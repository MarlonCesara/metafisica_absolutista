...
- Ao tentar retirar um fragmento de um infinito, percebe-se que não é possível medir esse infinito para considerar a retirada de uma parte. Portanto, o infinito não existe como fragmentável.
  - *Exemplo:* Ao tentar medir um metro de uma rua que não se pode medir, percebe-se que a rua não é uma dimensão para se medir. Logo, a rua não existe de forma que se possa extrair dela um fragmento.
...
### Liberdade do Ser (Incorruptível)
...
### Liberdade do "sou" (Corruptível)

- **Negação da Autodeterminação (Corrupção Imanente)**:
  - O homem que não escolhe existir permanece guiado por uma personalidade (alma) herdada, sem autoconsciência, autodomínio e autopresença.
- **Negação do Ente (Corrupção Destrutiva)**:
  - Aquele que se autodetermina só pode negar-se optando pela aniquilação de si mesmo.
- **Negação pelo Ser (Corrupção Extrínseca)**:
  - Se o "sou" não se sustenta, - isto é, falha em se autodefinir como causa de sua própria continuidade e determinação - o Ser pode suspender sua sustentação ontológica, tornando-se irreal para si mesmo (embora permaneça real como pura possibilidade)."
...
- O livre-arbítrio, em seu estado puro (neutralidade), implica a coexistência de todas as possibilidades hipotéticas simultaneamente.
...
- A alma é uma manifestação determinada do Absoluto, porém não necessária para a autofundamentação do Ser, ou seja, a alma é corruptível. É revelada no tempo sob determinação do Espírito Perfeito.
- O âmbito espiritual da alma determinada é relativo à sua própria existência, não se refere ao direcionamento espiritual do Ser que é essencialmente perfeito.
...
- Toda escolha horizontal (existencial) implica um direcionamento vertical (espiritual).
