...
### Pessoalização do Absoluto  

Sendo o absoluto auto causal, antes de pensarmos em atribuir-lhe aspectos conceituais como o "nada" ou o "fenomeno" ou "aparição", partimos do pressuposto mais básico que é inferido diretamente do contexto auto causal que se deduz a presença.

Em termos mais simples: se dispensarmos o termo "nada" ou o termo "fenomeno" como auto fundamento, podemos pensar em uma "presença" que independe do fenômeno ou da complexa inexistencia para se auto justicar — ou seja, que não precisa se manifestar fenomenicamente para existir e nem agir em si de forma a se extinguir com o intuito de ser auto-causal, mas que ainda assim se autofundamenta. Essa existência, por ter um caráter autocausal (isto é, uma natureza vivida por si mesma), é eleita como "presença". Assim, temos uma forma de existência incognoscível, mas que se afirma por sua autocausalidade uma pessoalidade. 
...
Do ponto de vista lógico, o fenomenização do absoluto exige um pressuposto externo a pura auto-causalidade, tal como deduzir o nada para absoluto, conceito que é rasgado pela ideia de presença pessoal e auto causal. Trata-se de uma existência de caráter pessoal e dotada de potência causal. Definamos portanto, o termo presença como Espírito. Desta forma se remete a uma presença nao fenomenológica. Baseada numa auto causalidade que independe da aparição.
...
Ao considerarmos o nada fenomenológico possível, ele seria um elemento auto-extinguível. Ou seja, se esgotarmos o nada fenomenológico—isto é, se removermos sua dependência de um referencial—, ele deixa de ser uma negação relativa e se torna **pura auto-supressão**. 
...
Não havendo um estado intermediário entre auto-supressão e fenômeno, o nada é um estado imaginário fictício, que nos permite imaginar a auto-supressão como um possível evocar do fenômeno. Isto é, não existe o produto da auto-supressão que aniquila a si mesmo, pois a auto-supressão é um ato determinístico tanto quanto a manifestação.

Ou seja, o nada é um autodeterminador, tem a auto-supressão como efeito de sua própria natureza; porém, como conceito fictício, somente representa e não é a ação determinística em si. O nada, portanto, não existe e, consequentemente, não tem efeito auto-supressor sobre si. A auto-supressão não tem um objeto auto-suprimido, mas é o ato puro de supressão.

Ao passo que a manifestação não é oriunda de um desfazer da auto-supressão, mas é um estado determinado em razão da possibilidade de supressão ou não-supressão.
...
Em uma analogia, o fenômeno é uma névoa numa campina da existência, que se esvai quando o sol aparece, sem deixar vestígios.
...
Tanto o **campo fenomenológico** quanto a **ação auto-supressora** (que esgota o fenômeno) seriam determinações internas do Absoluto. Isso sugere que o Absoluto, em sua natureza primordial, não se limita a determinações fixas, mas abriga em si uma dinâmica de possibilidades. No entanto, conforme o **Princípio da Causa Identitária**, toda determinação exige uma razão suficiente: **por que o Absoluto se manifesta de uma forma e não de outra?**  
