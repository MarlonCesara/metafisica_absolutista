...
## **1. O Nada como Fenômeno Relacional**  

Ao concebermos o nada como uma existência potencialmente manifestável—isto é, como uma nulidade ou neutralização da existência—, estamos operando dentro de um quadro fenomenológico. Esse "nada" não é uma ausência absoluta, mas uma **negação determinada**, dependente de um referencial.  
...
Nesse sentido, o **nada fenomenológico** é um fenômeno lógico, uma possibilidade dentro do campo do Ser. Ele não é autossuficiente, mas **determinado pelo que nega**.  

## **2. O Nada Auto-Supressor: A Dissolução do Fenomenológico**  

Se esgotarmos o nada fenomenológico—isto é, se removermos sua dependência de um referencial—, ele deixa de ser uma negação relativa e se torna **pura auto-supressão**.  

- **O Nada Puro não se Sustenta**:  
...
Assim, a **auto-supressão do nada** implica necessariamente a emergência do **existente**—não necessariamente um fenômeno determinado, mas uma **presença incognoscível**, anterior à manifestação fenomenológica. 

### **3. O Campo Relativo: O Absoluto Indiferenciado**  

Tanto o **nada fenomenológico** (como negação fenomênica) quanto a **ação auto-supressora** (que dá origem ao fenômeno) são determinações internas do Absoluto. Isso sugere que o Absoluto, em sua natureza primordial, não se limita a determinações fixas (A ou B), mas abriga em si uma dinâmica de possibilidades determinadas. No entanto, conforme o **Princípio da Causa Identitária**, toda determinação exige uma razão suficiente: **por que o Absoluto se manifesta de uma forma e não de outra?** 

Ao considerar que o nada, em seu sentido radical, poderia servir como explicação última — já que não impõe forma nem existência pode se apresentar autofundamentado e autodeterminado —, tal concepção se mostra inviável logicamente. Uma investigação rigorosa do conceito de nada revela que é impossível tomá-lo como fundamento de tudo e, a partir dele, derivar a existência.  

Se tentássemos fundamentar a realidade no **nada auto-supressor** ou no nada fenomênico, esbarraríamos em uma contradição lógica: o nada auto-supressor se revela como presença ativa, ou seja, como uma determinação ativa do Absoluto, assim como o nada fenomênico também se manifesta.  

Assim, a **forma** (ou determinação) só pode emergir de uma **existência prévia** — não detectável empiricamente, mas necessariamente **ativa**. Essa existência não se reduz a fenômenos, mas é **pura pessoalidade** (subjetividade absoluta) e **poder de ação** (causalidade irrestrita).  

A forma, portanto, permanece inerente — ou interna — a uma existência indetectável (espírito). Trata-se de uma existência que encarna pessoalidade e potência causal, mas que não se manifesta como forma ou aparência.  

E que é exterior a toda determinação interna. Ou seja, se existe uma ação pura — uma existência capaz de justificar uma realidade autocausada —, essa ação não pode comprometer a pureza da totalidade.  

Em termos mais simples: se o "nada radical" não serve como fundamento, podemos pensar em uma "presença" que independe do fenômeno – ou seja, que não precisa se manifestar para existir, mas que ainda assim se autofundamenta. Essa presença, por ter um caráter auto causal (isto é, uma natureza vivida por si mesma), é eleita como "presença". Assim, temos uma forma de existência incognoscível, mas que se afirma por sua autocausalidade.

Essa presença não se justifica pelo fenômeno, mas pela pessoalidade auto causal – algo que se determina a si mesmo e, por isso, incorpora os traços de uma persona: autoconhecimento, autodomínio e auto presença.


#### **A Pureza do Relativo**  

Ao considerar que, a pessoalidade espiritual não carrega determinação (nada fenomenológico ou nada auto-supressor), mas se entrega como pureza absoluta. É possível considerar que, qualquer determinação afetaria o estado de pureza tornando inelegível o espirito como fundamento do absoluto, a menos que a mudança deterministica fosse interna, de forma que ja esteja consumada e dissolvida no espírito.

Desta forma, o Espírito, sendo a consumação do processo deterministico, é possível ainda assim constituir-se como base causal de toda determinação.

Definamos esta base causal como estado relativo do Espírito. O **estado relativo** é a expressão dinâmica do Absoluto em sua **indiferenciação ativa**: um estado em que todas as possibilidades estão **simultaneamente suspensas e realizadas**, sem contradição. Nele:  
...
Em sintese: a fundamentação é o absoluto consumado, de fora que a totalidade da soma dos eventos temporais, resultasse num momento único atemporal. Desta forma, a soma de todas as deterinações possíveis, impossíveis e incognocíveis, resulta na pureza em ato único.

Portanto, o absoluto, em sua integralidade é Espirito, e em sua internalidade também o é, porém, resume os acontecimentos temporais em um ato atemporal.


#### **Conclusão: O Relativo como Autoexpressão do Absoluto**  
...
### O absoluto cognocível como Ser-aí
  - O agente da autodeterminação é puro, mas sua ação determinante é eficaz. Assim, afirma-se o 'Ser-aí'. Sendo o "Ser", não anterior ou extrinseco ao "Ai" (absoluto cognocivel), mas puro ao "Ai".
...
Na temporalidade, todas ações são manifestadas de forma temporal: possível, impossível e incognocível. 
...
Conclui-se que, a pureza (integralidade) não "esconde" ou "envolve" a determinação temporal, mas a resume em uma sintese auto-fundamentadora. 
Sendo tudo considerado uma sub nível da pureza, sendo a pureza a existência mais firme. Ou seja, o fenomeno não seria um impecilho à pureza, mas teria uma tendencia a pureza total de forma que sua opacidade tende ao nada radical e não realmente a pureza.

Desta forma, temos que, o fenomeno, não é uma concretude no espírito, mas um esboço de uma falta de concretude, o que permite a autofundamentação. Ou seja, ao imaginarmos que os fenomenos não são opacos, mas translucidos de forma a tenderem para o nada auto-supressor.

Desta forma, sendo o Espírito a existencia mais firme, o fenomeno tende a má translucidez, que é a translucidez que não fundamenta, a auto-supressora.
Sendo assim, todo evento não afeta a pureza, mas tende a ela para encontrar seu fundamento eterno.
