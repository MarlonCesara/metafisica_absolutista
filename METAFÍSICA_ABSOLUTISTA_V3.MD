...
Para tornar possível esse entendimento e conduzir até ele, este tratado apresenta um sistema metafísico completo e autoconsistente: uma estrutura lógica fechada, na qual cada proposição decorre necessariamente da anterior, obedecendo a um rigor demonstrativo absoluto. Não se trata de um conjunto de especulações, mas de uma edificação conceitual exata, cujas conclusões emergem como consequências inevitáveis dos próprios fundamentos da racionalidade. Trata-se da filosofia levada ao seu limite último.
